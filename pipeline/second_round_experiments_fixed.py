#!/usr/bin/env python3
"""
Second Round Hyperparameter Experiments - FIXED VERSION
...
- Added proper logging for all epochs
- Used proven architecture from first round
"""
...
class ExperimentManager:
    ...
    def __init__(self, checkpoint_file="second_round_checkpoint_fixed.json"):
...
def main():
    ...
    logger.info("🚀 Starting Second Round Hyperparameter Experiments (FIXED)")
    logger.info("=" * 60)
    ...
    if all_results:
        ...
        best_config_file = "best_second_round_config_fixed.json"
        ...
        plt.title('Second Round Hyperparameter Tuning Results (FIXED)')
        ...
        plt.savefig('second_round_results_fixed.png', dpi=300, bbox_inches='tight')
        logger.info("📊 Summary plot saved: second_round_results_fixed.png")
